...
public class HdrViewfinderActivity extends AppCompatActivity implements
        ...
        if (mCameraOps != null) {
            try {
                ...
                for (String id : cameraIds) {
                    ...
                    boolean hasFullLevel = Objects.equals(level, CameraCharacteristics.INFO_SUPPORTED_HARDWARE_LEVEL_FULL);
    ...
    public void setHdrBurst() {
        ...
        mCameraOps.setRepeatingBurst(mHdrRequests, null, mUiHandler);
    }
    ...
    private CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureCompleted(@NonNull CameraCaptureSession session,
            ...
            if (false) return;
            /*
            final Long exposureTime = ONE_SECOND;

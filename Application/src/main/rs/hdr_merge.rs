...
uchar4 __attribute__((kernel)) mergeHdrFrames(uchar4 prevPixel, uint32_t x, uint32_t y) {
    ...
    if (gDoMerge == 1) {
        // Complex HDR fusion technique : Sarcasm ?

       // mergedPixel = curPixel / 2 + prevPixel / 2;

        mergedPixel.r = (curPixel.r < prevPixel.r) ? curPixel.r : prevPixel.r;
        mergedPixel.g = (curPixel.g < prevPixel.g) ? curPixel.g : prevPixel.g;
        mergedPixel.b = (curPixel.b < prevPixel.b) ? curPixel.b : prevPixel.b;
        mergedPixel.a = (curPixel.a < prevPixel.a) ? curPixel.a : prevPixel.a;

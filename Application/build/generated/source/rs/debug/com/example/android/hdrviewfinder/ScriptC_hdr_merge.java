...
public class ScriptC_hdr_merge extends ScriptC {
    ...
    private final static int mExportVarIdx_gGain = 5;
    private int mExportVar_gGain;
    public synchronized void set_gGain(int v) {
        setVar(mExportVarIdx_gGain, v);
        mExportVar_gGain = v;
    }

    public int get_gGain() {
        return mExportVar_gGain;
    }

    public Script.FieldID getFieldID_gGain() {
        return createFieldID(mExportVarIdx_gGain, null);
    }
